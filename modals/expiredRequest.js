...
class ExpiredRequest extends Component {
    ...
    render() {
        return (
            ...
            <View style={styles.container}>
                <Text>Sorry that was too late!</Text>
                <Text>:(</Text>
                <DefaultButton onPress={this.onCloseHandler}>Close</DefaultButton>
            </View>
            // </Modal>
        )
    }
...
export default connect(mapStateToProps, mapActionsToProps)(ExpiredRequest)
