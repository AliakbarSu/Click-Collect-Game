...
class AwaitingResults extends Component {
    ...
    render() {
        return (
            ...
            <View style={styles.container}>
                <Text>Waiting for the results to become available</Text>
                <Text>Exciting whoo!!!</Text>
            </View>
            // </Modal>
        )
    }
...
export default connect(mapStateToProps, mapActionsToProps)(AwaitingResults)
